...
package com.maortoubian.aroundmeapi;
...
public class Aroundmeapi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
    ...
    public class GetAllUsers extends AroundmeapiRequest<com.maortoubian.aroundmeapi.model.UserAroundMeCollection> {
        ...
        protected GetAllUsers(java.lang.String userMail) {
            super(Aroundmeapi.this, "GET", REST_PATH, null, com.maortoubian.aroundmeapi.model.UserAroundMeCollection.class);
    ...
    public class GetMessage extends AroundmeapiRequest<com.maortoubian.aroundmeapi.model.Message> {
        ...
        protected GetMessage(java.lang.Long messageId) {
            super(Aroundmeapi.this, "GET", REST_PATH, null, com.maortoubian.aroundmeapi.model.Message.class);
    ...
    public class GetUsersAroundMe extends AroundmeapiRequest<com.maortoubian.aroundmeapi.model.UserAroundMeCollection> {
    ...
    public class Login extends AroundmeapiRequest<com.maortoubian.aroundmeapi.model.User> {
        ...
        protected Login(java.lang.String mail, java.lang.String password, java.lang.String registrationId) {
            super(Aroundmeapi.this, "POST", REST_PATH, null, com.maortoubian.aroundmeapi.model.User.class);
     ...
     *
     * @param content the {@link com.maortoubian.aroundmeapi.model.User}
     * @return the request
     */
    public Register register(com.maortoubian.aroundmeapi.model.User content) throws java.io.IOException {
        Register result = new Register(content);
        initialize(result);
        return result;
    }

    public class Register extends AroundmeapiRequest<com.maortoubian.aroundmeapi.model.User> {
         ...
         * @since 1.13
         */
        protected Register(com.maortoubian.aroundmeapi.model.User content) {
            super(Aroundmeapi.this, "POST", REST_PATH, content, com.maortoubian.aroundmeapi.model.User.class);
        }
     ...
     *
     * @param mail
     * @param content the {@link com.maortoubian.aroundmeapi.model.GeoPt}
     * @return the request
     */
    public ReportUserLocation reportUserLocation(java.lang.String mail, com.maortoubian.aroundmeapi.model.GeoPt content) throws java.io.IOException {
    ...
    public class ReportUserLocation extends AroundmeapiRequest<Void> {
         ...
         * @since 1.13
         */
        protected ReportUserLocation(java.lang.String mail, com.maortoubian.aroundmeapi.model.GeoPt content) {
     ...
     *
     * @param content the {@link com.maortoubian.aroundmeapi.model.Message}
     * @return the request
     */
    public SendMessage sendMessage(com.maortoubian.aroundmeapi.model.Message content) throws java.io.IOException {
    ...
    public class SendMessage extends AroundmeapiRequest<Void> {
         ...
         * @since 1.13
         */
        protected SendMessage(com.maortoubian.aroundmeapi.model.Message content) {
            super(Aroundmeapi.this, "POST", REST_PATH, content, Void.class);
        }
